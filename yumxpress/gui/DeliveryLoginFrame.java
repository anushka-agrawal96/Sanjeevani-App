 ...
 * @author ABC
 */
public class DeliveryLoginFrame extends javax.swing.JFrame {

    /**
     * Creates new form DeliveryLoginFrame
     */
    public DeliveryLoginFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yumxpress/image/staff_login.png"))); // NOI18N

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Delivery Login ");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       ...
       try{
           ...
           if(staff==null){
               JOptionPane.showMessageDialog(null,"Invalid Email/Password. Try Again!");
               return;
           }
           UserProfile.setUserId(staff.getStaffId());
           UserProfile.setUserName(staff.getStaffName());
           UserProfile.setEmailId(staff.getEmailId());
           DeliveryStaffOptionFrame option = new DeliveryStaffOptionFrame();
           option.setVisible(true);
           this.dispose();
       }
       catch(SQLException ex){
            JOptionPane.showMessageDialog(null,"DB Error in DeliveryStaffLoginFrmae");
            ex.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeliveryLoginFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeliveryLoginFrame().setVisible(true);
            }
        });
    }
